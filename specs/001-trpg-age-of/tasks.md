...
**次のTDDサイクル (バックエンド):**
- [ ] T017 TDD: データ完全性テスト実装（全フィールド保存・取得検証）
- [ ] T018 TDD: 大容量データ処理テスト（パフォーマンス）
- [ ] T019 TDD: 並行アクセステスト（同時更新検証）

**フロントエンド側で実装予定:**
- [ ] F001 TDD: キャラクター作成ビジネスロジック（能力値計算）
- [ ] F002 TDD: 技能初期値計算ロジック
- [ ] F003 TDD: ヒーロースキル制約チェック
- [ ] F004 TDD: 特殊技制約チェック
- [ ] F005 TDD: キャラクターシートUI実装
