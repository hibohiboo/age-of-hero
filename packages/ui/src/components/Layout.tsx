...
export const Layout: React.FC<LayoutProps> = ({ children, title = 'Age of Hero TRPG' }) => (
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8 py-4 sm:py-6">
          ...
          <nav className="mt-4">
            <ul className="flex flex-col sm:flex-row space-y-2 sm:space-y-0 sm:space-x-6">
              <li><a href="/" className="block py-1 hover:text-blue-200 transition-colors">ホーム</a></li>
              <li><a href="/rules" className="block py-1 hover:text-blue-200 transition-colors">ルール</a></li>
