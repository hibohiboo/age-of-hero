...
- [ ] **データ構造**: 各データが正しい構造を持つこと
  ...
  - [ ] ヒーロースキルがmaxLevel/costを持つこと
  - [ ] アイテムがpriceを持つこと
- [ ] **CORS**: CORSヘッダーが適切に設定されていること
- [ ] **エラーハンドリング**: 不正なHTTPメソッドで405を返すこと
...
- [ ] **バリデーション**: リクエストデータの検証
  - [ ] nameが必須であること
  - [ ] nameが1-50文字であること
  - [ ] selectedClassesが2つであること
  - [ ] skillAllocationsが数値であること
  - [ ] skillAllocationsの合計が150以下であること
- [ ] **パスワード**: オプションのパスワード設定
  - [ ] パスワードありで作成できること
  - [ ] パスワードが4文字以上であること
  - [ ] パスワードなしで作成できること
...
- [ ] **パスワード保護**: 
  - [ ] 保護なしのキャラクターを取得できること
  - [ ] 正しいパスワードで保護されたキャラクターを取得できること
  - [ ] 間違ったパスワードで401を返すこと
  - [ ] パスワード必須で未提供時に401を返すこと
- [ ] **エラーハンドリング**:
  - [ ] 存在しないIDで404を返すこと
  - [ ] 不正なUUID形式で400を返すこと
...
- [ ] **正常系**: パスワード設定/変更が成功すること
  - [ ] 新しいパスワードを設定できること
  - [ ] 既存パスワードを変更できること
  - [ ] パスワードを削除できること（null指定）
  - [ ] ステータス200を返すこと
- [ ] **認証**:
  - [ ] パスワード変更時は現在のパスワードが必要
  - [ ] 間違った現在パスワードで401を返すこと
  - [ ] 初回設定時は認証不要
- [ ] **バリデーション**:
  - [ ] 新パスワードが4文字以上であること
  - [ ] 新パスワードがnullの場合保護を解除すること
- [ ] **エラーハンドリング**:
  - [ ] 存在しないIDで404を返すこと
